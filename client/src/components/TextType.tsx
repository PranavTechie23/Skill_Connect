...
export type TextTypeProps = React.HTMLAttributes<HTMLElement> & {
  text: string | string[];
    ...
    const executeTypingAnimation = () => {
      if (isDeleting) {
        ...
        if (currentCharIndex < processedText.length) {
          ...
          // When finished typing the current sentence:
          // - If there are multiple sentences, or loop is enabled, start deleting after a pause
